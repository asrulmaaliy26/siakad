                ...
                Section::make('Ujian Tengah Semester (UTS)')
                    ...
                    ->schema([
                        ...
                        FileUpload::make('soal_uts')
                            ...
                            ->disk('public')
                            ->visibility('public')
                            ->directory(fn($get, $record) => \App\Helpers\UploadPathHelper::uploadPath($record, 'soal_uts', 'dosen', $get))
                ...
                Section::make('Ujian Akhir Semester (UAS)')
                    ...
                    ->schema([
                        ...
                        FileUpload::make('soal_uas')
                            ...
                            ->disk('public')
                            ->directory(fn($get, $record) => \App\Helpers\UploadPathHelper::uploadPath($record, 'soal_uas', 'dosen', $get))
                            ->visibility('public')
                            ->acceptedFileTypes(['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'image/*'])
                            ->preserveFilenames()
                            ->maxSize(10240)
